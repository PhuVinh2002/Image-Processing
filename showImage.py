...
with open('C:\\Users\\Admin\\Desktop\\raw_edgeVertical.dat', 'rb') as file:
    data1 = file.read()
with open('C:\\Users\\Admin\\Desktop\\raw_edgeHorizontal.dat', 'rb') as file:
    data2 = file.read()
with open('C:\\Users\\Admin\\Desktop\\raw_edgeDiagonalDown.dat', 'rb') as file:
    data3 = file.read()
with open('C:\\Users\\Admin\\Desktop\\raw_edgeDiagonalUp.dat', 'rb') as file:
    data4 = file.read()

with open('C:\\Users\\Admin\\Desktop\\raw_edgeVertical1.dat', 'rb') as file:
    data5 = file.read()
with open('C:\\Users\\Admin\\Desktop\\raw_edgeHorizontal1.dat', 'rb') as file:
    data6 = file.read()
with open('C:\\Users\\Admin\\Desktop\\raw_edgeDiagonalDown1.dat', 'rb') as file:
    data7 = file.read()
with open('C:\\Users\\Admin\\Desktop\\raw_edgeDiagonalUp1.dat', 'rb') as file:
    data8 = file.read()
